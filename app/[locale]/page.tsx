...
function SectionHeading({ title, subtitle }: { title: string; subtitle?: string }) {
  return (
    <div className="text-center space-y-2">
      <h2 className="text-3xl md:text-4xl font-display tracking-tight text-slate-900">
        {title}
      </h2>
      {subtitle ? (
        <p className="text-slate-600 max-w-3xl mx-auto text-lg">{subtitle}</p>
      ) : null}
    </div>
  );
}
    ...
    <main className="min-h-screen bg-gradient-to-b from-sakura-50 via-white to-mizu-50 text-slate-900">
      <div className="relative overflow-hidden">
        ...
        <header className="sticky top-0 z-30 backdrop-blur bg-white/80 shadow-sm">
          <nav className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg md:text-xl font-display text-slate-900">
        ...
        <section className="relative isolate overflow-hidden">
          <div className="mx-auto max-w-6xl px-6 pt-16 pb-20 md:pt-20 md:pb-24 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-3 text-sm text-slate-600 max-w-xl">
                {messages.hero.highlights.map((item) => (
                  <div
                    key={item.title}
                    className="rounded-2xl bg-white/70 p-4 border border-slate-100 shadow-soft"
                  >
          ...
          <div className="mx-auto max-w-6xl px-6 space-y-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {messages.services.items.map((service) => (
                ...
                >
                  <div className="h-12 w-12 rounded-2xl bg-sakura-100 text-sakura-700 grid place-items-center font-semibold">
                    •
                  </div>
                  <div className="space-y-2">
        ...
        <section id="pricing" className="py-16 md:py-20 bg-white/70">
          <div className="mx-auto max-w-6xl px-6 space-y-10">
          ...
          <div className="mx-auto max-w-6xl px-6 space-y-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {messages.gallery.images.map((image) => (
                <div
                  key={image.src}
                  className="overflow-hidden rounded-3xl border border-slate-100 shadow-soft bg-white/70"
                >
                  <Image src={image.src} alt={image.alt} width={800} height={600} className="h-full w-full object-cover hover:scale-105 transition-transform" sizes="(min-width: 1024px) 280px, 48vw" />
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="reviews" className="py-16 md:py-20 bg-white/70">
          <div className="mx-auto max-w-6xl px-6 space-y-10">
          ...
          <div className="mx-auto max-w-5xl px-6 space-y-10">
            ...
            <div className="space-y-4">
              {messages.faq.items.map((item) => (
                <details
                  key={item.question}
                  className="group rounded-2xl border border-slate-100 bg-white/80 shadow-soft p-5"
                >
        ...
        <section id="booking" className="py-16 md:py-20 bg-white/70">
